...
## Experiment
EXPERIMENT=lidar_rain_combined
RUN=_run_0
...
python -m hannah.train \
        ...
        module.augmentor.augmentations.rain.precipitation_sigma=6.285 \
        module.augmentor.augmentations.rain.number_drops_sigma=0.4870 \
        module.augmentor.augmentations.rain.prob=0.8629 \
