...
## Experiment
EXPERIMENT=lidar_random_noise_uniform_light_fog
RUN=_run_0
...
python -m hannah.train \
        ...
        module.augmentor.augmentations.random_noise.type='uniform' \
        module.augmentor.augmentations.random_noise.sigma='interval(0, 30000)' \
