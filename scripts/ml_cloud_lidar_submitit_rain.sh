...
## Experiment
EXPERIMENT=lidar_rain_light_fog
RUN=_run_0
...
python -m hannah.train \
        ...
        module.augmentor.augmentations.rain.enabled=true \
        module.augmentor.augmentations.rain.precipitation_sigma='interval(0.1, 10)' \
        module.augmentor.augmentations.rain.number_drops_sigma='interval(0.1, 2)' \
        module.augmentor.augmentations.rain.prob='interval(0, 1)' \
        module.augmentor.augmentations.rain.noise_filter_path='/mnt/qb/datasets/STAGING/bringmann/datasets/noisefilter/' \
