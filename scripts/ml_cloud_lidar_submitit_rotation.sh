...
## Experiment
EXPERIMENT=lidar_random_rotation_light_fog
RUN=_run_1
...
python -m hannah.train \
        ...
        module.augmentor.augmentations.random_rotation.enabled=true \
        module.augmentor.augmentations.random_rotation.sigma='interval(1, 100)' \
