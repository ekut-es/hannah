...
python -m hannah.train \
        ...
        module.augmentor.augmentations.fog.sigma=11.8 \
        module.augmentor.augmentations.fog.prob=0.82 \
        module.augmentor.augmentations.fog.mean=200 \
