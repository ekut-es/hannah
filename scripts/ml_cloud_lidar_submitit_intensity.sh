...
## Experiment
EXPERIMENT=lidar_random_intensity_shift_light_fog
RUN=_run_1
...
python -m hannah.train \
        ...
        module.augmentor.augmentations.random_intensity_shift.enabled=true \
        module.augmentor.augmentations.random_intensity_shift.sigma='interval(0, 50)' \
