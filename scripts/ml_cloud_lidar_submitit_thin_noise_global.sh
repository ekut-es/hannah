...
## Experiment
EXPERIMENT=lidar_thin_noise_combined
RUN=_run_0
...
python -m hannah.train \
        ...
        module.augmentor.augmentations.random_noise.enabled=true \
        module.augmentor.augmentations.random_noise.type='salt_pepper' \
        module.augmentor.augmentations.random_noise.sigma=9325 \
        module.augmentor.augmentations.thin_out.enabled=true \
        module.augmentor.augmentations.thin_out.sigma=0.2967 \
