...
## Experiment
EXPERIMENT=lidar_random_flip_light_fog
RUN=_run_1
...
hannah-train \
        ...
        module.augmentor.augmentations.random_flip.enabled=true \
        module.augmentor.augmentations.random_flip.prob='interval(0, 1)' \
        ...
        trainer.gpus=[0] \
        dataset.DATA_PATH=/mnt/qb/datasets/STAGING/bringmann/datasets/dense \
