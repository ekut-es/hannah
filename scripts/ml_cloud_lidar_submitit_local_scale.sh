...
## Experiment
EXPERIMENT=lidar_local_scale_light_fog
RUN=_run_0
...
python -m hannah.train \
        ...
        module.augmentor.augmentations.local_scaling.enabled=true \
        module.augmentor.augmentations.local_scaling.sigma='interval(0, 5)' \
