...
## Experiment
EXPERIMENT=lidar_fog_dist_mean_light_fog
RUN=_run_0
...
python -m hannah.train \
        ...
        module.augmentor.augmentations.fog.metric='dist' \
        module.augmentor.augmentations.fog.sigma='interval(1, 100)' \
        module.augmentor.augmentations.fog.mean='interval(10, 500)' \
        module.augmentor.augmentations.fog.prob=1 \
