...
## Experiment
EXPERIMENT=lidar_min_points_light_fog
RUN=_run_0
...
python -m hannah.train \
        ...
        module.augmentor.augmentations.delete_labels_by_min_points.enabled=true \
        module.augmentor.augmentations.delete_labels_by_min_points.min_points='interval(0, 50)' \
