...
python -m hannah.train \
        ...
        module.augmentor.augmentations.snow.precipitation_sigma='interval(0.1, 10)' \
        module.augmentor.augmentations.snow.number_drops_sigma='interval(0.1, 2)' \
        module.augmentor.augmentations.snow.prob='interval(0, 1)' \
        module.augmentor.augmentations.snow.scale='interval(0, 10)' \
        ...
        dataset.VALIDATION_PATH=/mnt/qb/datasets/STAGING/bringmann/datasets/dense_snow \
