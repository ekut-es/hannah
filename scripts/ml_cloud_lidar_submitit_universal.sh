...
## Experiment
EXPERIMENT=lidar_universal_weather_light_fog
RUN=_run_0
...
python -m hannah.train \
        ...
        module.augmentor.augmentations.universal_weather.enabled=true \
        module.augmentor.augmentations.universal_weather.prob=1 \
        module.augmentor.augmentations.universal_weather.sigma='interval(0, 100)' \
        module.augmentor.augmentations.universal_weather.mean='interval(10, 500)' \
        module.augmentor.augmentations.universal_weather.ext_a='interval(0, 1)' \
        module.augmentor.augmentations.universal_weather.ext_b='interval(0, 1)' \
        module.augmentor.augmentations.universal_weather.beta_a='interval(0, 0.1)' \
        module.augmentor.augmentations.universal_weather.beta_b='interval(0, 10)' \
        module.augmentor.augmentations.universal_weather.del_a='interval(0, 1)' \
        module.augmentor.augmentations.universal_weather.del_b='interval(0, 0.5)' \
        module.augmentor.augmentations.universal_weather.int_a='interval(0, 10)' \
        module.augmentor.augmentations.universal_weather.int_b='interval(0, 10)' \
        module.augmentor.augmentations.universal_weather.mean_int='interval(0, 255)' \
        module.augmentor.augmentations.universal_weather.int_range='interval(0, 255)' \
