...
def preprocess_audio(data, n_mels, dct_filters, preprocessing='mel'):
    if preprocessing == "mel":
        data = librosa.feature.melspectrogram(data, sr=16000,
                                          n_mels=n_mels, hop_length=160,
        ...
        raise Exception("Unknown feature extractor: {}".format(preprocessing))
