#!/bin/bash
 ...
 python3.6 -m speech_recognition.tcml.train --data_folder datasets/speech_commands_v0.02/ --wanted_words yes no up down left right on off stop go --n_labels 12 --n_epochs 500 --model ekut-raw-cnn1 --gpu_no 0 --seed 1234 --lr 0.0001 --tcml_skip_data --tcml_skip_simage --tcml_skip_code --tcml_estimated_time 12:00:00 --tcml_partition day

 python3.6 -m speech_recognition.tcml.train --data_folder datasets/speech_commands_v0.02/ --wanted_words yes no up down left right on off stop go --n_labels 12 --n_epochs 500 --model ekut-raw-cnn2 --gpu_no 0 --seed 1234 --lr 0.0001 --tcml_skip_data --tcml_skip_simage --tcml_skip_code --tcml_estimated_time 12:00:00 --tcml_partition day

 python3.6 -m speech_recognition.tcml.train --data_folder datasets/speech_commands_v0.02/ --wanted_words yes no up down left right on off stop go --n_labels 12 --n_epochs 500 --model ekut-raw-cnn3 --gpu_no 0 --seed 1234 --lr 0.0001 --tcml_skip_data --tcml_skip_simage --tcml_skip_code --tcml_estimated_time 12:00:00 --tcml_partition day
...
python3.6 -m speech_recognition.tcml.train --data_folder datasets/speech_commands_v0.02/ --wanted_words yes no up down left right on off stop go --n_labels 12 --n_epochs 500  --gpu_no 0  --lr 0.1 --seed 1234 --model honk-res8 --tcml_skip_data --tcml_skip_simage --tcml_skip_code --tcml_estimated_time 12:00:00 --tcml_partition day
...
python3.6 -m speech_recognition.tcml.train --data_folder datasets/speech_commands_v0.02/ --wanted_words yes no up down left right on off stop go --n_labels 12 --n_epochs 500  --gpu_no 0  --lr 0.1 --seed 1234 --model tc-res8 --tcml_skip_data --tcml_skip_simage --tcml_skip_code --tcml_estimated_time 12:00:00 --tcml_partition day

python3.6 -m speech_recognition.tcml.train --data_folder datasets/speech_commands_v0.02/ --wanted_words yes no up down left right on off stop go --n_labels 12 --n_epochs 500  --gpu_no 0  --lr 0.1 --seed 1234 --model tc-res8-15 --tcml_skip_data --tcml_skip_simage --tcml_skip_code --tcml_estimated_time 12:00:00 --tcml_partition day

python3.6 -m speech_recognition.tcml.train --data_folder datasets/speech_commands_v0.02/ --wanted_words yes no up down left right on off stop go --n_labels 12 --n_epochs 500  --gpu_no 0  --lr 0.1 --seed 1234 --model tc-res14 --tcml_skip_data --tcml_skip_simage --tcml_skip_code --tcml_estimated_time 12:00:00 --tcml_partition day
