...
def tv_resnext50_32x4d_mc_dropout(pretrained=False, **kwargs):
    ...
    return _create_resnet(
        "tv_resnext50_32x4d", pretrained, **dict(model_args, **kwargs)
    )
...
def ig_resnext101_32x8d_mc_dropout(pretrained=False, **kwargs):
    ...
    return _create_resnet(
        "ig_resnext101_32x8d", pretrained, **dict(model_args, **kwargs)
    )
...
def ig_resnext101_32x16d_mc_dropout(pretrained=False, **kwargs):
    ...
    return _create_resnet(
        "ig_resnext101_32x16d", pretrained, **dict(model_args, **kwargs)
    )
...
def ig_resnext101_32x32d_mc_dropout(pretrained=False, **kwargs):
    ...
    return _create_resnet(
        "ig_resnext101_32x32d", pretrained, **dict(model_args, **kwargs)
    )
...
def ig_resnext101_32x48d_mc_dropout(pretrained=False, **kwargs):
    ...
    """
    model_args = dict(
        block=Bottleneck, layers=[3, 4, 23, 3], cardinality=32, base_width=48
    )
    return _create_resnet(
        "ig_resnext101_32x48d", pretrained, **dict(model_args, **kwargs)
    )
...
def ssl_resnext50_32x4d_mc_dropout(pretrained=False, **kwargs):
    ...
    return _create_resnet(
        "ssl_resnext50_32x4d", pretrained, **dict(model_args, **kwargs)
    )
...
def ssl_resnext101_32x4d_mc_dropout(pretrained=False, **kwargs):
    ...
    return _create_resnet(
        "ssl_resnext101_32x4d", pretrained, **dict(model_args, **kwargs)
    )
...
def ssl_resnext101_32x8d_mc_dropout(pretrained=False, **kwargs):
    ...
    return _create_resnet(
        "ssl_resnext101_32x8d", pretrained, **dict(model_args, **kwargs)
    )
...
def ssl_resnext101_32x16d_mc_dropout(pretrained=False, **kwargs):
    ...
    return _create_resnet(
        "ssl_resnext101_32x16d", pretrained, **dict(model_args, **kwargs)
    )
...
def swsl_resnext50_32x4d_mc_dropout(pretrained=False, **kwargs):
    ...
    return _create_resnet(
        "swsl_resnext50_32x4d", pretrained, **dict(model_args, **kwargs)
    )
...
def swsl_resnext101_32x4d_mc_dropout(pretrained=False, **kwargs):
    ...
    return _create_resnet(
        "swsl_resnext101_32x4d", pretrained, **dict(model_args, **kwargs)
    )
...
def swsl_resnext101_32x8d_mc_dropout(pretrained=False, **kwargs):
    ...
    return _create_resnet(
        "swsl_resnext101_32x8d", pretrained, **dict(model_args, **kwargs)
    )
...
def swsl_resnext101_32x16d_mc_dropout(pretrained=False, **kwargs):
    ...
    return _create_resnet(
        "swsl_resnext101_32x16d", pretrained, **dict(model_args, **kwargs)
    )
...
@register_model
def seresnet18_mc_dropout(pretrained=False, **kwargs):
    model_args = dict(
...
@register_model
def seresnet34_mc_dropout(pretrained=False, **kwargs):
    model_args = dict(
...
@register_model
def seresnet50_mc_dropout(pretrained=False, **kwargs):
    model_args = dict(
...
@register_model
def seresnet50t_mc_dropout(pretrained=False, **kwargs):
    model_args = dict(
        block=Bottleneck,
        layers=[3, 4, 6, 3],
        stem_width=32,
...
@register_model
def seresnet101_mc_dropout(pretrained=False, **kwargs):
    model_args = dict(
...
@register_model
def seresnet152_mc_dropout(pretrained=False, **kwargs):
    model_args = dict(
...
@register_model
def seresnet152d_mc_dropout(pretrained=False, **kwargs):
    model_args = dict(
        block=Bottleneck,
        layers=[3, 8, 36, 3],
        stem_width=32,
...
def seresnext26tn_32x4d_mc_dropout(pretrained=False, **kwargs):
    ...
    """
    return seresnext26t_32x4d_mc_dropout(pretrained=pretrained, **kwargs)


@register_model
def seresnext50_32x4d_mc_dropout(pretrained=False, **kwargs):
    model_args = dict(
        block=Bottleneck,
        layers=[3, 4, 6, 3],
        cardinality=32,
...
@register_model
def seresnext101_32x4d_mc_dropout(pretrained=False, **kwargs):
    model_args = dict(
        block=Bottleneck,
        layers=[3, 4, 23, 3],
        cardinality=32,
...
@register_model
def seresnext101_32x8d_mc_dropout(pretrained=False, **kwargs):
    model_args = dict(
        block=Bottleneck,
        layers=[3, 4, 23, 3],
        cardinality=32,
...
@register_model
def seresnext101d_32x8d_mc_dropout(pretrained=False, **kwargs):
    model_args = dict(
        block=Bottleneck,
        layers=[3, 4, 23, 3],
        cardinality=32,
...
@register_model
def senet154_mc_dropout(pretrained=False, **kwargs):
    model_args = dict(
        block=Bottleneck,
        layers=[3, 8, 36, 3],
        cardinality=64,
