...
from hannah.models.embedded_vision_net_grouped_pw.blocks import (
    block,
    classifier_head,
    cwm_block,
    stem,
)
from hannah.models.embedded_vision_net_grouped_pw.expressions import (
    expr_and,
    expr_product,
    extract_macs_recursive,
    extract_weights_recursive,
)
from hannah.models.embedded_vision_net_grouped_pw.operators import (
