...
class _EConvNd(
    ...
    def reset_parameters(self):
        super(_EConvNd, self).reset_parameters()
    ...
    def _forward(self, input):
        ...
        if self.training:
            ...
            if self.bias is not None:
                bias = self.bias
            bias = self.bias_fake_quant(bias).reshape(bias_shape)
            conv = conv + bias
    ...
    def extra_repr(self):
        # TODO(jerryzh): extend
        return super(_EConvNd, self).extra_repr()
    ...
    def _load_from_state_dict(
        ...
        super(_EConvNd, self)._load_from_state_dict(
            state_dict,
            prefix,
            local_metadata,
            strict,
