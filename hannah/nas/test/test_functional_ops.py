...
from hannah.nas.functional_operators.op import ChoiceOp, OptionalOp, Tensor, scope, nodes_in_scope
...
def test_scoping():
    ...
    test_scope = 'double_conv_1.Conv2d_0'
    scopes = []
...
def test_choice():
    ...
    net = choice_block()
    assert 'choice_block_0.ChoiceOp_0.choice' in net.parametrization(flatten=True)
    net.parametrization(flatten=True)['choice_block_0.ChoiceOp_0.choice'].set_current(0)
    net.parametrization(flatten=True)['choice_block_0.ChoiceOp_0.choice'].set_current(1)
    net.parametrization(flatten=True)['choice_block_0.ChoiceOp_0.choice'].set_current(2)
